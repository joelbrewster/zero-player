  ...
  (function (root, factory) {
    ...
    Module(function (Tone) {
      ...
      Tone.AudioToGain = function () {
         ...
         *  @private
         */
        this._norm = this.input = this.output = new Tone.WaveShaper(function (
          x
        ) {
          return (x + 1) / 2;
        });
    ...
    Module(function (Tone) {
      ...
      Tone.Transport.prototype._processTick = function (tickTime) {
        ...
        if (
          ...
          tickTime +=
            Tone.Time((this._swingTicks * 2) / 3, "i").eval() * amount;
        }
        //do the loop test
        if (this.loop) {
    ...
    Module(function (Tone) {
      ...
      Object.defineProperty(Tone.Oscillator.prototype, "type", {
        ...
        set: function (type) {
          ...
          var periodicWave = this.context.createPeriodicWave(
            coefs[0],
            coefs[1]
          );
